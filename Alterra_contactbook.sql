...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 16 2021 г., 11:17
...
-- База данных: `alterra`
--
CREATE DATABASE IF NOT EXISTS `alterra` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `alterra`;

-- --------------------------------------------------------

--
-- Структура таблицы `contact_book`
--
...
--
-- AUTO_INCREMENT для таблицы `contact_book`
--
ALTER TABLE `contact_book`
...
('root', '[{\"db\":\"alterra\",\"table\":\"contact_book\"},{\"db\":\"pokemons\",\"table\":\"pokemons\"},{\"db\":\"alterra\",\"table\":\"contact book\"}]');
...
('root', '2021-08-16 09:15:57', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- База данных: `pokemons`
--
CREATE DATABASE IF NOT EXISTS `pokemons` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pokemons`;
...
INSERT INTO `pokemons` (`ID`, `name`, `attack`, `defense`, `tipo`, `ataque`, `experiencia`, `img`) VALUES
(1, 'Pachirisu', 419, 49, 'water', 'aque_jet', 'cooo', 'img/Pachiri.png'),
(2, 'Charizard', 543, 23, 'water', 'aura_wheel', 'dooo', 'img/Chariza.png'),
(3, 'Tyranitar', 61, 200, 'water', 'aque_jet', 'pooo', 'img/Tyranit.png'),
(4, 'Quilava', 78, 543, 'fire', 'blast_burn', 'pooo', 'img/Quilava.png'),
(5, 'Pikachu', 421, 67, 'electric', 'aura_wheel', 'cooo', 'img/Pikachu.png'),
(6, 'Pyroar', 245, 15, 'electric', 'acupressure', 'cooo', 'img/Pyroar.png'),
(7, 'Squirtle', 356, 111, 'normal', 'aura_wheel', 'dooo', 'img/Squirtl.png');
